...
use QuantaQuirk\Broadcasting\Broadcasters\LogBroadcaster;
use QuantaQuirk\Broadcasting\Broadcasters\NullBroadcaster;
...
use QuantaQuirk\Contracts\Broadcasting\Factory as FactoryContract;
...
/**
 * @mixin \QuantaQuirk\Contracts\Broadcasting\Broadcaster
 */
class BroadcastManager implements FactoryContract
{
     ...
     *
     * @param  \QuantaQuirk\Contracts\Container\Container  $app
     * @return void
     */
    ...
    public function routes(array $attributes = null)
    {
        ...
        $this->app['router']->group($attributes, function ($router) {
            ...
            )->withoutMiddleware([\QuantaQuirk\Foundation\Http\Middleware\VerifyCsrfToken::class]);
        });
    }
